[tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/KavyaSJ/raspberrypitss/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/KavyaSJ/raspberrypitss  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43005  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='KavyaSJ'  \-\-env DOCKERUSERNAME='kavyasj'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
[tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/KavyaSJ/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10-cc4a
...
.. important::
   solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=40779, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=36225, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=43973, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=44753, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=36477, HPDEHOST=172.17.0.2, HPDEPORT=35337, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=36061

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9222-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a, python-preprocess-4321-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a, python-ml-1878-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a, python-predict-8928-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a, python-agenticai-679-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
