Scaling [tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml -f ollama.yml

tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/KavyaSJ/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10-cc4a/ymls/tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai
             image: kavyasj/tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'tml-multi-agenticai-iot-3f10-cc4a'                              
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-cc4a'
             - name: GITUSERNAME
               value: 'KavyaSJ'
             - name: GITREPOURL
               value: 'https://github.com/KavyaSJ/raspberrypitss'
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai-visualization-service
       labels:
         app: tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-cc4a-ml_agenticai.yml
